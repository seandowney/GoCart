...
class Admin extends Admin_Controller
{
	...
	function organize()
	{
		...
		$this->images_model->organize($banners);
	}
	...
	function delete($id)
	{
		...
		redirect($this->config->item('admin_folder').'/modules/images');
	}
	...
	********************************************************************/
	...
	function form($id = false)
	{
		...
		{	
			...
			$this->images_model->save_banner($save);
